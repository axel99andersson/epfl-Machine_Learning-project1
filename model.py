...
Prints out the best combination of degree and lambda-value as well as model accuracy
and model loss.

"""
# Load Data
set_of_features = 0 #Can be either 0, 1, 2 or 3 corresponding to PRI_jet_num
...
# Build Model (Performs cross-validation for each lambda and degree of polynomial)
degrees = [1]
